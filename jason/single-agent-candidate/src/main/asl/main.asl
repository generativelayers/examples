 ...
 *
 * Demonstrates a simple agent executing an LLM goal, inspecting the
 * generated candidate, validating it against an expected schema,
 * and accepting the candidate to adopt the corresponding domain beliefs.
 */
